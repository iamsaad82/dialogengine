...
export async function GET() {
    try {
        ...
        return NextResponse.json({ error: 'Fehler beim Laden der Flowise-Konfigurationen' }, { status: 500 });
    }
}
// POST /api/flowise
export async function POST(request) {
    try {
        ...
        return NextResponse.json({ error: 'Fehler beim Erstellen der Flowise-Konfiguration' }, { status: 500 });
    }
}
// PUT /api/flowise/:id
export async function PUT(request) {
    try {
        ...
        return NextResponse.json({ error: 'Fehler beim Aktualisieren der Flowise-Konfiguration' }, { status: 500 });
    }
}
...
export async function DELETE(request) {
    try {
        ...
        return NextResponse.json({ error: 'Fehler beim Löschen der Flowise-Konfiguration' }, { status: 500 });
    }
}
